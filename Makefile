...
${OUTDIR}/assets: ${SRCDIR}/assets
	rm -Rf ${OUTDIR}/assets
	mkdir -p ${OUTDIR}/assets
	cp -Rf ${SRCDIR}/assets ${OUTDIR}

${OUTDIR}/bundle.js: ${JS_SOURCES}
	webpack ${SRCDIR}/main.jsx ${OUTDIR}/bundle.js

all: .prerequisites directories ${OUTDIR}/bundle.js ${OUTDIR}/model.json ${OUTDIR}/index.html ${POSTS_OBJECTS} ${ASSETS_OBJECTS}
